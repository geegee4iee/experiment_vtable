...
fn main() {
    unsafe {
        ...
        let kitty_raw_ptr = std::ptr::addr_of!(kitty);

        let addr_of_kitty = kitty_raw_ptr as usize; // Same as addr_of_data_ptr
        let ptr_to_kitty = addr_of_kitty as *const Box<dyn Pet>; // Same as kitty_raw_ptr
